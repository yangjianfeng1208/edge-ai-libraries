...
#define GST_GVA_MOTION_DETECT(obj) \
	(G_TYPE_CHECK_INSTANCE_CAST((obj), GST_TYPE_GVA_MOTION_DETECT, GstGvaMotionDetect))
#define GST_GVA_MOTION_DETECT_CLASS(klass) \
	(G_TYPE_CHECK_CLASS_CAST((klass), GST_TYPE_GVA_MOTION_DETECT, GstGvaMotionDetectClass))
#define GST_IS_GVA_MOTION_DETECT(obj) \
	(G_TYPE_CHECK_INSTANCE_TYPE((obj), GST_TYPE_GVA_MOTION_DETECT))
#define GST_IS_GVA_MOTION_DETECT_CLASS(klass) \
	(G_TYPE_CHECK_CLASS_TYPE((klass), GST_TYPE_GVA_MOTION_DETECT))

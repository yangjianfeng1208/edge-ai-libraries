...
C3_MODEL_PATH, C3_MODEL_PROC_PATH = get_model_path(C3_MODEL_NAME), get_model_proc_path(
    C3_MODEL_NAME
)
...
GROUND_TRUTH_CV = [
    BBox(
        ...
        0.5060393810272217,
        [
            {"label": "21", "layer_name": "age_conv3", "name": "age"},
            {"label": "Male", "layer_name": "prob", "name": "gender"},
            {"label": "surprise", "layer_name": "prob_emotion", "name": "emotion"},
            {
                "data": [
                    0.38138410449028015,
                    0.3854252099990845,
    ...
    BBox(
        ...
        0.5096779465675354,
        [
            {"label": "Female", "layer_name": "prob", "name": "gender"},
            {"label": "happy", "layer_name": "prob_emotion", "name": "emotion"},
            {"label": "25", "layer_name": "age_conv3", "name": "age"},
            {
                "data": [
                    0.2102919965982437,
                    0.36596113443374634,
...
GROUND_TRUTH_IE = [
    ...
    BBox(
        ...
        [
            {"label": "Female", "layer_name": "prob", "name": "gender"},
            {"label": "happy", "layer_name": "prob_emotion", "name": "emotion"},
            {"label": "26", "layer_name": "age_conv3", "name": "age"},
            {
                "data": [
                    0.2102919965982437,
                    0.36596113443374634,

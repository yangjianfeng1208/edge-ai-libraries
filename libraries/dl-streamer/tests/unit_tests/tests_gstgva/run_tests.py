...
if __name__ == "__main__":
    ...
    suite_gstgva.addTests(loader.loadTestsFromModule(test_pipeline_color_formats))
    suite_gstgva.addTests(
        loader.loadTestsFromModule(test_pipeline_face_detection_and_classification)
    )
    suite_gstgva.addTests(
    ...
    suite_gstgva.addTests(loader.loadTestsFromModule(test_pipeline_vehicle_pedestrian_tracker))
    suite_gstgva.addTests(
        loader.loadTestsFromModule(test_pipeline_classification_mobilenet_v2_onnx)
    )
    suite_gstgva.addTests(loader.loadTestsFromModule(test_audio_event))
    suite_gstgva.addTests(loader.loadTestsFromModule(test_audio_frame))
    suite_gstgva.addTests(loader.loadTestsFromModule(test_pipeline_gvapython))
    suite_gstgva.addTests(loader.loadTestsFromModule(test_pipeline_gvapython_vaapi))
    suite_gstgva.addTests(loader.loadTestsFromModule(test_pipeline_action_recognition))
    suite_gstgva.addTests(loader.loadTestsFromModule(test_pipeline_human_pose_estimation))

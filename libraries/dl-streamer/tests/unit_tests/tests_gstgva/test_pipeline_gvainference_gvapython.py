...
MODULE_PATH = os.path.join(SCRIPT_DIR, "test_files", "instance_segmentation_0002_postproc.py")
MODEL_PROC_PATH = os.path.join(SCRIPT_DIR, "test_files", "instance-segmentation-security-0002.json")

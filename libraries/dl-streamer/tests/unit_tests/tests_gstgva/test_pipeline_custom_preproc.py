...
appsrc name=mysrc
! jpegparse ! vajpegdec ! video/x-raw
! gvaclassify inference-region=full-frame pre-process-backend=va device=CPU model={C_MODEL_PATH} model-proc={C_MODEL_PROC_PATH}
! appsink name=mysink emit-signals=true sync=false
"""

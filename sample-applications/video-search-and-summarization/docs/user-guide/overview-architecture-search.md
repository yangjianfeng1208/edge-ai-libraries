...
![System Architecture Diagram](./images/TEAI_VideoSearch.drawio.svg)
...
![Technical Architecture Diagram of video ingestion](./images/TEAI_VideoSearch_Arch-ingest.drawio.svg)

*Figure 1: Architecture of video ingestion process

![Technical Architecture Diagram of video query](./images/TEAI_VideoSearch_Arch-query.drawio.svg)

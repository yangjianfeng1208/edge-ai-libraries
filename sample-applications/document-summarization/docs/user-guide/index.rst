...
- **LLM inference microservice**: Intel's optimized `OpenVINO™ Model Server <https://github.com/openvinotoolkit/model_server>`__ runs LLMs on Intel® hardware efficiently. Developers have other model serving options if required.
